...
*/
	...
	unsigned char* data = stbi_load("..\\Texture\\unnamed1.jpg", &width, &height, & nrChannel, 0);
	if (data) 
	{
	...
	/*	glm::mat4 trans;
		...
		glm::mat4 modelMat;
		modelMat = glm::rotate(modelMat, (float)glfwGetTime() * glm::radians(-35.0f), glm::vec3(0.3f, 1.0f, 0));
		glm::mat4 viewMat;
		viewMat = glm::translate(viewMat, glm::vec3(0, 0, -3.0f));	//translate camera to origin point
		glm::mat4 proMat;
		proMat = glm::perspective(glm::radians(45.0f), 800.0f / 600.f, 0.1f, 100.0f);
		...
		*/
		...
		// -- draw triangle number is 3 while rectangle is 6
